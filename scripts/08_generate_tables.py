...
=====================
Generate publication-quality tables as CSV and LaTeX for the Magdalena
...
def generate_table5_municipal_risk() -> pd.DataFrame:
    ...
    _save_latex_styled(
        ...
        caption="Top 20 municipalities in Magdalena ranked by composite flood risk score. "
...
def generate_table6_population_exposure() -> pd.DataFrame:
    ...
    total_row = {"Subregion": "TOTAL (Magdalena)"}
    ...
    _save_latex_styled(
        ...
        caption="Population exposure to flood risk by subregion in Magdalena. "
...
def generate_table7_seasonal_dynamics() -> pd.DataFrame:
    ...
    showing the bimodal precipitation/flood pattern in Magdalena.
    """
    ...
    _save_latex_styled(
        ...
        caption="Monthly flood extent statistics for Magdalena (2015--2025). "
...
def main() -> None:
    ...
    logger.info("=" * 70)
    logger.info("TABLE GENERATION - MAGDALENA FLOOD RISK ASSESSMENT")
    logger.info("=" * 70)
